...
# # #                     small_region = cropped.crop((left, upper, right, lower))
...
# # model = None
# # weights = None
# # threshold = 30  # Define threshold for frame similarity
...
# #     total_color = np.array([0, 0, 0], dtype=np.float64)
# #     frame_count = 0
# #     rolling_avg = None  # Track rolling average for filtering frames
